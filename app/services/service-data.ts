...
export const serviceDetails: ServiceDetail[] = [
  {
    ...
    description: "LevelServe designs AI solutions around real workflows, not technology for its own sake. We help clients identify high-value use cases, connect trusted business data, automate repetitive processes and deploy secure AI experiences that are easy for teams to adopt.",
  ...
  },
  {
    ...
    description: "LevelServe takes mobile products from idea to production with product strategy, UX, engineering, backend integration, testing and release support. We focus on performance, reliability, accessibility and a user experience strong enough to support long-term adoption.",
  ...
  },
  {
    ...
    description: "LevelServe helps clients extend their teams with carefully matched technology specialists. We focus on practical fit, communication, delivery discipline and clear accountability so augmented talent feels like part of the client team rather than an external handoff.",
  ...
  },
  {
    ...
    description: "LevelServe combines product thinking, UX research, interaction design and interface design to create experiences that are useful, understandable and consistent. We work closely with engineering so the final product reflects the design intent.",
  ...
  },
  {
    ...
    description: "We build web experiences that balance strong design with solid engineering. Whether the requirement is a marketing website, customer portal or complex SaaS product, LevelServe focuses on speed, accessibility, maintainability and conversion-ready user journeys.",
  ...
  },
  {
    ...
    description: "Off-the-shelf software is not always a fit. LevelServe designs and builds custom systems around real operational needs, with careful attention to architecture, security, integrations, data and long-term maintainability.",
  ...
  },
  {
    ...
    description: "LevelServe treats security as part of engineering rather than a final checklist. We help clients identify weaknesses, improve application and cloud security, strengthen access controls and build more secure delivery practices.",
  ...
  },
  {
    ...
    description: "LevelServe helps organisations use the Power Platform to replace manual processes, connect information and create practical internal applications. We balance rapid delivery with governance, maintainability and integration needs.",
  ...
  },
  {
    ...
    description: "LevelServe helps clients build and modernise cloud applications while connecting the systems their business already depends on. We focus on resilient integration patterns, secure APIs, clean data movement and migration plans that minimise operational disruption.",
