...
export const marketingServiceDetails: ServiceDetail[] = [
  {
    ...
    description: "LevelServe helps businesses plan, launch and improve Google Ads campaigns with clear targeting, stronger landing-page alignment and reliable conversion measurement. We focus on the business outcome behind the clicks—not vanity traffic.",
  ...
  },
  {
    ...
    description: "LevelServe improves the technical and content foundations that help search engines understand and trust a website. We combine technical SEO, content structure, local signals, performance improvements and practical keyword strategy around how customers actually search.",
  ...
  },
  {
    ...
    description: "LevelServe plans Meta campaigns around the audience, offer and conversion path—not just boosted posts. We support campaign structure, targeting, creative direction, tracking and optimization for Facebook and Instagram.",
  ...
  },
  {
    ...
    description: "LevelServe helps clients build a clearer digital growth plan across the channels that matter most. We connect website experience, search visibility, paid campaigns, content and measurement so marketing activity supports a consistent customer journey.",
