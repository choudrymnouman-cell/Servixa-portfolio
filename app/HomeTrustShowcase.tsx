...
export default function HomeTrustShowcase(){
  useEffect(()=>{
    ...
    if(heroCopy){
      heroCopy.textContent="LevelServe delivers professional digital solutions with a strong focus on quality, affordable pricing, on-time delivery and complete client satisfaction. From first discussion to final delivery, we stay accountable, transparent and committed to results.";
    }
  ...
  return <section className="servixa-trust" aria-label="Why businesses choose LevelServe">
    <div className="shell">
      <div className="servixa-trust-grid">
        <div className="servixa-trust-copy">
          ...
          <p>LevelServe combines professional execution, clear communication and dependable support to give every client a smooth experience from planning through launch and ongoing improvement.</p>
        ...
        <div className="servixa-stats" aria-label="LevelServe experience and ratings">
      ...
      <div className="servixa-platform-row servixa-trust-badges">
        <div><small>LevelServe trust badges</small><strong>✓ 100+ Projects</strong><strong>★ 5.0/5 Rated</strong><strong>✓ 4+ Years Experience</strong><strong>✓ On-Time Delivery</strong><strong>🔒 SSL Secured</strong><strong>✓ Privacy & Terms</strong></div>
      ...
      <div className="servixa-project-proof">
        ...
        <div className="servixa-project-cards">
          <article><span>01 · DIGITAL PRODUCT</span><h3>Choudhry Sons</h3><p>A modern business-focused digital experience built to present services clearly, strengthen credibility and support customer engagement.</p><div><b>LevelServe project</b><b>5/5 delivery standard</b></div></article>
          <article><span>02 · EDTECH APP</span><h3>BrainBoost</h3><p>An exam-preparation product experience combining mobile workflows, quizzes and scalable backend capabilities for learners.</p><div><b>LevelServe project</b><b>5/5 delivery standard</b></div></article>
        </div>
      </div>
    </div>
  </section>;
